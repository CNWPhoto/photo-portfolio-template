export default {
  ...
  preview: {
    prepare() {
      return {title: 'Get in Touch Section'}
    },
  },
  fields: [
    {
    ...
    },
    {
      ...
      rows: 3,
      placeholder:
        "If you're ready to have photographs that actually look and feel like you, I'd love to hear from you.",
    },
    {
      name: 'buttonText',
      title: 'Button Text',
    ...
    },
    {
      ...
      type: 'string',
      description: 'Small text displayed below the button. E.g. "Serving [City] and surrounding areas."',
