...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'array',
      description:
        'Add, remove, and drag to reorder sections on the Homepage. Add a Hero section at the top via the "Hero" group in the Add button.',
      group: 'sections',
      initialValue: [
        {_type: 'heroSection',              _key: 'heroSection'},
